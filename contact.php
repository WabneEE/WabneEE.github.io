...
$rate_limit_file = sys_get_temp_dir() . "/contact_" . md5($ip) . ".txt";
$last_submit_time = file_exists($rate_limit_file) ? (int) file_get_contents($rate_limit_file) : 0;
if (time() - $last_submit_time < 30) {
	echo "<h3 style='color:red;'>You're sending messages too quickly. Please wait 30 seconds.</h3>";
	exit();
}
$confirmationMessage = "";
$recaptchaSecret = "6Le9njcrAAAAAOyIFI_VwXsLVnaJ_xKKL0Oof-fE";
if ($_SERVER["REQUEST_METHOD"] === "POST") {
	...
	if (!$recaptchaData->success) {
		$confirmationMessage = "<h3 style='color:red;'>reCAPTCHA failed. Please try again.</h3>";
	} else {
						...
						<body>
							<div class="card">
								...
								<div class="content">
									...
									<p>
										We have received your message and we truly appreciate your interest. Here is a summary of your submission:
									</p>
									<ul>
									...
									<p>Warm Regards,<br />TernCoders (terncoders@gmail.com)</p>
								</div>
							</div>
						</body>
					</html>
